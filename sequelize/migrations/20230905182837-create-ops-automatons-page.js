...
module.exports = {
   async up(queryInterface, Sequelize) {
      ...
      const permissionsOnRoles = [
         ...
         {
            id: '6deb57ae-ecd6-400a-af05-f88fadca9ce5',
            permissionId: 'b87dbae8-b875-4eab-a351-781dfaba94d8',
   ...
   async down(queryInterface, Sequelize) {
      ...
      const pagePermissionsToRevert = ['b87dbae8-b875-4eab-a351-781dfaba94d8'];
      ...
      await queryInterface.bulkDelete('pagesLookup', { id: '30a752c0-83c5-4d45-92ff-ef636c1785d9' });
   },
};
