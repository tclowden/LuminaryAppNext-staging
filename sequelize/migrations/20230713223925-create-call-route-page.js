...
module.exports = {
   async up(queryInterface, Sequelize) {
      ...
      await queryInterface.bulkInsert('pagesLookup', [
         {
            id: '7fe3d4d9-4511-4cfc-ab88-0c44af51d799',
            name: 'Call Route',
            iconName: null,
            iconColor: null,
      ...
      const pagePermissions = [
         {
            id: '33010458-5d3e-4fb7-8c60-4a19b3ca2d81',
            archived: false,
            description: "Allow user to access an individual 'Call Route' page within the 'Phone Numbers' section.",
            isDefaultPermission: true,
            name: 'View Call Route Page',
            addPermissionToSuperAdmin: true,
            pageId: '7fe3d4d9-4511-4cfc-ab88-0c44af51d799',
            action: 'create',
         },
      ];
      ...
      //       id: '97e48ab2-733f-4714-bd43-e58884d7138a',
      //       archived: false,
      //       permissionId: '33010458-5d3e-4fb7-8c60-4a19b3ca2d81',
      //       action: 'create',
      //    },
      // ];
      ...
      const permissionsOnRoles = [
         {
            id: '598ebfce-ea5f-4317-b7c8-9252dcc7d171',
            permissionId: '33010458-5d3e-4fb7-8c60-4a19b3ca2d81',
            roleId: 'b1421034-7ad9-40fc-bc3b-dc4f00c7e285',
            action: 'create',
         },
         {
            id: '9366e098-1f34-448e-9f8b-d53084d17163',
            permissionId: '33010458-5d3e-4fb7-8c60-4a19b3ca2d81',
   ...
   async down(queryInterface, Sequelize) {
      ...
      const pagePermissionsToRevert = ['33010458-5d3e-4fb7-8c60-4a19b3ca2d81'];
      ...
      await queryInterface.bulkDelete('pagesLookup', { id: '7fe3d4d9-4511-4cfc-ab88-0c44af51d799' });
   },
};
