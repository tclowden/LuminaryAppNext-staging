...
module.exports = {
   async up(queryInterface, Sequelize) {
      ...
      await queryInterface.bulkInsert('pagesLookup', [
         {
            id: '4319780f-90b0-44e2-8a38-d19b060753f5',
            name: 'My Calendar',
            iconName: 'CalendarScheduled',
            iconColor: null,
            route: 'my-calendar',
      ...
      const permissionsOnRoles = [
         {
            id: '07a0462d-1ad2-49fb-8647-caa6ebf679f5',
            permissionId: '3a049b60-3dc5-4ccb-bd72-19f2363a0db3',
            roleId: 'b1421034-7ad9-40fc-bc3b-dc4f00c7e285',
            action: 'create',
         },
         {
            id: '7f83e3da-0362-4fe0-9813-2c57c42a2f89',
            permissionId: '3a049b60-3dc5-4ccb-bd72-19f2363a0db3',
   ...
   async down(queryInterface, Sequelize) {
      ...
      const pagePermissionsToRevert = ['3a049b60-3dc5-4ccb-bd72-19f2363a0db3'];
      ...
      await queryInterface.bulkDelete('pagesLookup', { id: '4319780f-90b0-44e2-8a38-d19b060753f5' });
   },
};
