...
module.exports = {
   async up(queryInterface, Sequelize) {
      ...
      await queryInterface.bulkInsert('pagesLookup', [
         {
            id: '0c12759e-2b2d-4031-9e59-4782a91d9e4f',
            name: 'Segments',
            iconName: 'Users',
            iconColor: null,
      ...
      const permissionsOnRoles = [
         {
            id: '09190e14-96b3-42e5-9f0f-00f045338816',
            permissionId: '76d53a85-b5f3-46a5-93af-80f1e2f567da',
            roleId: 'b1421034-7ad9-40fc-bc3b-dc4f00c7e285',
            action: 'create',
         },
         {
            id: '0410cb5b-deed-4efe-ac42-3376d57aee77',
            permissionId: '76d53a85-b5f3-46a5-93af-80f1e2f567da',
   ...
   async down(queryInterface, Sequelize) {
      ...
      const pagePermissionsToRevert = ['76d53a85-b5f3-46a5-93af-80f1e2f567da'];
      ...
      await queryInterface.bulkDelete('pagesLookup', { id: '0c12759e-2b2d-4031-9e59-4782a91d9e4f' });
   },
};
